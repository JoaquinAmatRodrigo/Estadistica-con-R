...
Este repositorio contiene apuntes personales sobre estadística, bioestadística, *machine learning* y lenguaje de programación R, principalmente aplicada al campo de la biología. Si encuentran algún error o para cualquier comentario no duden en contactarme **j.amatrodrigo@gmail.com**. Para ver los artículos en formato html visitar [Rpubs](https://rpubs.com/Joaquin_AR).
